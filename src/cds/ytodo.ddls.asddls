...
*/
@AbapCatalog.sqlViewName: 'Y_TODO'
...
@ObjectModel: {
  ...
  deleteEnabled: true,
  updateEnabled: true,
  writeActivePersistence: 'YTODO_ROOT_DB',

  -- Additional annotations for draft enablement
  draftEnabled: true,
  writeDraftPersistence: 'YTODO_D', // suffix: '_D' for all draft persistences
